...
En archivos **ASS**, la opción **Predeterminada / conservar** mantiene la fuente, colores, posiciones y estilos originales. Si eliges otra fuente, ZeroTwo cambia únicamente la familia tipográfica y conserva el resto del diseño ASS.
