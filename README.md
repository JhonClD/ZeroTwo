...
En archivos **ASS**, la opción **Predeterminada / conservar** mantiene la fuente y los estilos originales, pero coloca el texto abajo por defecto (`Alignment=2`, `MarginV=12`), como en los subtítulos de anime habituales. Si eliges otra fuente o alineación, ZeroTwo cambia esos valores y conserva colores, tamaños, bordes y demás estilos ASS.
